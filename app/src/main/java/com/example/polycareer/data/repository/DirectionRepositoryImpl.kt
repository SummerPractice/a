...
class DirectionRepositoryImpl : DirectionRepository {
    private val directionsList = listOf(
        ...
        DirectionInfo(
            ...
            "Основной целью программы является подготовка специалистов, обладающих знаниями в областях прикладной математики, проектировании и администрировании баз данных, теории и технологиях программирования высокоуровневых информационных систем. Междисциплинарные связи и сквозные проекты в рамках практик и стажировок помогают студентам решать комплексные задачи в сфере автоматизации и информатизации, а также анализа данных.",
        ...
        DirectionInfo(
            ...
            "Целью программы является подготовка специалистов для решения задач в области автоматизации, обработки данных и информационного обеспечения интеллектуальных систем управления -- как для крупных промышленных производств, так и для создания систем по типу \"Умный дом\". Наша задача - дать студентам знания о фундаментальных основах теории систем искусственного интеллекта и распределенных интеллектуальных систем.",
